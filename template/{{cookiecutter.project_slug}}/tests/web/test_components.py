...
from {{cookiecutter.project_slug}}.web.components.model_card import display_model_card
from {{cookiecutter.project_slug}}.web.components.message import message, show_error
from {{cookiecutter.project_slug}}.web.components.menu import menu
